...
function StickerForm() {
  const sheetsAPI = new URL(
    "https://script.google.com/macros/s/AKfycbzQQK1AFWPBH5a5mjdF3QDS5Bixf23Rk5VeE1sc2QgS2qq5T_o-VbgT/exec"
  );
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(values).forEach((key) =>
      sheetsAPI.searchParams.append(key, values[key])
    );
  ...
  const stickerPage = () => (
    <div class="stickerform-container">
      ...
      <br></br>
      <p>
        *By pressing submit, you are agreeing to be added to our email list
        featuring news about CMMND releases and promotions
      </p>
      <br></br>
    </div>
  );
